...
```bash
# Run with a prompt
clfnai run z-image "a sunset over mountains"
...
```bash
# Generate an image
clfnai run z-image "a cat playing piano"
...
- Modelfiles not yet supported (use `clfnai create` from model directory)
